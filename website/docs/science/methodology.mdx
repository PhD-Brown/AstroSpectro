...
Cette page décrit les choix scientifiques et techniques qui sous-tendent chaque étape du pipeline de classification spectrale. Pour une représentation visuelle, référez-vous au [schéma sur le README du projet](https://github.com/PhD-Brown/AstroSpectro#pipeline-structure).
