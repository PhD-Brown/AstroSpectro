...
- [Catalogue des 183 descripteurs](./features-list-183) — familles spectrales, loadings PC1/PC2
- [Dataset PHY-3500](./dataset-dimred) — composition du jeu, filtres, standardisation
- [XGBoost — comparaison supervisée](./xgboost-comparison) — cohérence avec la structure UMAP
- [Guide de visualisation](../user-guides/visualization) — reproduire les figures