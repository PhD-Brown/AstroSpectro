...
- [Catalogue des 183 descripteurs](./features-list-183) — définitions physiques complètes
- [Réduction de dimension](./dimensionality-reduction) — PCA, UMAP, t-SNE sur ce dataset
- [Interprétation physique de la PCA](./pca-physical-interpretation) — variance, eigenspectra, corrélations Gaia
- [Guide de téléchargement](../user-guides/downloading-data) — récupérer les spectres LAMOST DR5
- [Guide de prétraitement](../user-guides/preprocessing) — normalisation, lissage, contrôle qualité