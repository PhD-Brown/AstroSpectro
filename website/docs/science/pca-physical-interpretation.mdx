...
- [Catalogue des 183 descripteurs](./features-list-183) — définitions des *loadings* et familles
- [Réduction de dimension](./dimensionality-reduction) — UMAP, t-SNE, stabilité Procrustes
- [Dataset PHY-3500](./dataset-dimred) — composition du jeu, filtres, standardisation
- [XGBoost — comparaison supervisée](./xgboost-comparison) — 87 % de précision sur les mêmes 183 descripteurs