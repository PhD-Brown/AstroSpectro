...
import { faDownload, faWandSparkles, faMagic, faBrain, faChartPie } from '@fortawesome/free-solid-svg-icons'

# <FontAwesomeIcon icon={faWandSparkles} /> Guides Pratiques

Bienvenue dans les guides pratiques du projet **Astro-Spectro**. Cette section vous accompagne dans chaque étape clé du pipeline avec des tutoriels concrets et orientés tâche.
...
<div className="container" style={{padding: '0'}}>
  <div className="row">
    ...
    <div className="col col--6 margin-bottom--lg">
      <div className="card">
        <div className="card__header"><h3><FontAwesomeIcon icon={faWandSparkles} /> Extraction des Features</h3></div>
